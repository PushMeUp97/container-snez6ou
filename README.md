...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-snez6ou.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-snez6ou.containers.anotherwebservice.com/
...
```
git clone git@github.com:PushMeUp97/container-snez6ou.git
cd container-snez6ou
```
...
```
docker attach container-snez6ou
```
